...
public class CubeDescCreator {
    ...
    public static CubeDesc generateKylinCubeDescForMetricsQuery(KylinConfig config, SinkTool sinkTool) {
        ...
        int idx = getTimeRowKeyColDesc(rowKeyColDescs);
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryPropertyEnum.USER.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryPropertyEnum.PROJECT.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryPropertyEnum.REALIZATION.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryPropertyEnum.REALIZATION_TYPE.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryPropertyEnum.EXCEPTION.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryPropertyEnum.TYPE.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(RecordEvent.RecordReserveKeyEnum.HOST.toString(), idx + 1);
        idx++;
        ...
        aggGroup.setIncludes(dimensions.toArray(new String[dimensions.size()]));
    ...
    public static CubeDesc generateKylinCubeDescForMetricsQueryCube(KylinConfig config, SinkTool sinkTool) {
        ...
        RowKeyColDesc[] rowKeyColDescs = new RowKeyColDesc[dimensionDescList.size()];
        int idx = getTimeRowKeyColDesc(rowKeyColDescs);
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryCubePropertyEnum.CUBE.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryCubePropertyEnum.SEGMENT.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryCubePropertyEnum.CUBOID_SOURCE.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryCubePropertyEnum.CUBOID_TARGET.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryCubePropertyEnum.IF_MATCH.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryCubePropertyEnum.IF_SUCCESS.toString(), idx + 1);
        idx++;
    ...
    public static CubeDesc generateKylinCubeDescForMetricsQueryRPC(KylinConfig config, SinkTool sinkTool) {
        ...
        RowKeyColDesc[] rowKeyColDescs = new RowKeyColDesc[dimensionDescList.size()];
        int idx = getTimeRowKeyColDesc(rowKeyColDescs);
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryRPCPropertyEnum.PROJECT.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryRPCPropertyEnum.REALIZATION.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryRPCPropertyEnum.RPC_SERVER.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(RecordEvent.RecordReserveKeyEnum.HOST.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(QueryRPCPropertyEnum.EXCEPTION.toString(), idx + 1);
        idx++;
    ...
    public static CubeDesc generateKylinCubeDescForMetricsJob(KylinConfig config, SinkTool sinkTool) {
        ...
        RowKeyColDesc[] rowKeyColDescs = new RowKeyColDesc[dimensionDescList.size()];
        int idx = getTimeRowKeyColDesc(rowKeyColDescs);
        rowKeyColDescs[idx] = getRowKeyColDesc(JobPropertyEnum.USER.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(JobPropertyEnum.PROJECT.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(JobPropertyEnum.CUBE.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(JobPropertyEnum.ALGORITHM.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(JobPropertyEnum.TYPE.toString(), idx + 1);
        idx++;
    ...
    public static CubeDesc generateKylinCubeDescForMetricsJobException(KylinConfig config, SinkTool sinkTool) {
        ...
        rowKeyColDescs[idx] = getRowKeyColDesc(JobPropertyEnum.TYPE.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(JobPropertyEnum.EXCEPTION.toString(), idx + 1);
        idx++;
    ...
    public static int getTimeRowKeyColDesc(RowKeyColDesc[] rowKeyColDescs) {
        int idx = 0;
        rowKeyColDescs[idx] = getRowKeyColDesc(TimePropertyEnum.DAY_DATE.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(TimePropertyEnum.WEEK_BEGIN_DATE.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(TimePropertyEnum.MONTH.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(TimePropertyEnum.YEAR.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(TimePropertyEnum.TIME_HOUR.toString(), idx + 1);
        idx++;
        rowKeyColDescs[idx] = getRowKeyColDesc(TimePropertyEnum.TIME_MINUTE.toString(), idx + 1);
        idx++;
        return idx;
    }

    public static RowKeyColDesc getRowKeyColDesc(String column, int id) {
        RowKeyColDesc rowKeyColDesc = new RowKeyColDesc();
        rowKeyColDesc.setIndex(Integer.toString(id));
        rowKeyColDesc.setColumn(column);
    ...
    public static DimensionDesc getDimensionDesc(String tableName, String dimension) {
        ...
        dimensionDesc.setName(tableName + "." + dimension);
